...
# ---- Changelog ----
# [2026-02-23] Claude (Opus 4.6) — Initial creation.
...
class NGEcosystem:
    ...
    def _init_ng_lite(self) -> None:
        ...
        try:
            ...
            if self._state_path.exists():
                ...
                logger.debug(
                    "[%s] NGLite state loaded from %s",
                    self.module_id, self._state_path,
                )
    ...
    def _init_peer_bridge(self) -> None:
        ...
        try:
            ...
            logger.debug(
                "[%s] NGPeerBridge unavailable: %s", self.module_id, exc
            )
    ...
    def _try_tier3_upgrade(self) -> bool:
        ...
        try:
            ...
            logger.debug(
                "[%s] Tier 3 upgrade attempt failed: %s",
                self.module_id, exc,
            )
            return False
    ...
    def _find_neurograph_memory(self) -> Optional[Any]:
        ...
        try:
            ...
            if mem is not None:
                logger.debug(
                    "[%s] NeuroGraph found in-process", self.module_id
                )
                return mem
        except Exception:
            pass
    ...
    def get_recommendations(
        ...
        Returns list of (target_id, confidence) or None.
    ...
    def get_context(
        ...
        Returns a dict suitable for injecting into a prompt or logging:
            ...
            recommendations: list of (target_id, confidence)
    ...
    def stats(self) -> Dict[str, Any]:
        """Return unified telemetry for logging, dashboards, or SKILL.md output."""
            ...
            "ng_memory": (
                {
                    ...
                    "nodes": ng_memory_stats.get("nodes", "?"),
                }
